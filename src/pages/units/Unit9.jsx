...
import unit9Styles from '../../assets/styles/units/unit9.module.css';
...
export default function Unit9(props) {
    ...
    return (
        <div className={unit9Styles['article-container']}>
            <div className={unit9Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit9Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit9Styles['page-nav-button'] : unit9Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit9Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit9Styles['page-nav-button'] : unit9Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}