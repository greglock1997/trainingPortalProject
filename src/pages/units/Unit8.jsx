...
import unit8Styles from '../../assets/styles/units/unit8.module.css';
...
export default function Unit8(props) {
    ...
    return (
        <div className={unit8Styles['article-container']}>
            <div className={unit8Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit8Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit8Styles['page-nav-button'] : unit8Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit8Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit8Styles['page-nav-button'] : unit8Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}