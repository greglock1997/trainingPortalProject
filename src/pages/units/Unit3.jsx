...
import unit3Styles from '../../assets/styles/units/unit3.module.css';
...
export default function Unit3(props) {
    ...
    return (
        <div className={unit3Styles['article-container']}>
            <div className={unit3Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit3Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit3Styles['page-nav-button'] : unit3Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit3Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit3Styles['page-nav-button'] : unit3Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}