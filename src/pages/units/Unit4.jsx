...
import unit4Styles from '../../assets/styles/units/unit4.module.css';
...
export default function Unit4(props) {
    ...
    return (
        <div className={unit4Styles['article-container']}>
            <div className={unit4Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit4Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit4Styles['page-nav-button'] : unit4Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit4Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit4Styles['page-nav-button'] : unit4Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}