...
import unit6Styles from '../../assets/styles/units/unit6.module.css';
...
export default function Unit6(props) {
    ...
    return (
        <div className={unit6Styles['article-container']}>
            <div className={unit6Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit6Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit6Styles['page-nav-button'] : unit6Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit6Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit6Styles['page-nav-button'] : unit6Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}