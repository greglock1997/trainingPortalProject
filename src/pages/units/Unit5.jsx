...
import unit5Styles from '../../assets/styles/units/unit5.module.css';
...
export default function Unit5(props) {
    ...
    return (
        <div className={unit5Styles['article-container']}>
            <div className={unit5Styles['page-container']}>
                {pages[pageIndex]}
            </div>
            <div className={unit5Styles['page-nav-container']}>
                <div className={`${pageIndex > 0 ? unit5Styles['page-nav-button'] : unit5Styles['hidden']}`} onClick={previousPage}><i class="fa-solid fa-circle-left"></i></div>
                {pageIndex === (pages.length - 1) && <button className={unit5Styles['page-quiz-button']} onClick={props.togglePage}>Ready?</button>}
                <div className={`${pageIndex < (pages.length - 1) ? unit5Styles['page-nav-button'] : unit5Styles['hidden']}`} onClick={nextPage}><i class="fa-solid fa-circle-right"></i></div>
            </div>
        </div>
    );
}